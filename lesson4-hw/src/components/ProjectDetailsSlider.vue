    ...
    <div class="wrapper">
        <div class="slider">
            <div class="slider-items">
                ...
                <div class="item s1">
                    <img :src="require('../assets/img/SliderPhoto1.png')" alt="SliderPhoto1" width="1200" height="800">
                </div>
                <div class="item">
                    <img :src="require('../assets/img/SliderPhoto2.png')" alt="SliderPhoto2" width="1200" height="800">
                </div>
                <div class="item">
                    <img :src="require('../assets/img/SliderPhoto3.png')" alt="SliderPhoto3" width="1200" height="800">
                </div>
        </div>
        </div>
        <div class="svg">
    ...
    data() {
        return {
            ...
            sliders: [
                {
                    id: 1,
                    img: 'SliderPhoto1.png',
                },
                {
                    id: 2,
                    img: 'SliderPhoto2.png',
                },
                {
                    id: 3,
                    img: 'SliderPhoto3.png',
                },
            ]
        };
    },
...
<style lang="scss" scoped>
    ...
    * {
    ...
    .slider-nav-item {
        ...
        filter: drop-shadow(0px 4px 3px #676767) ;
        &:hover {
            background: #000;
        }
    }
